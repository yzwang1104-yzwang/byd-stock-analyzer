...
| 代码 | 股数 | 成本 | 现价 | 盈亏 |
|------|:--:|------|------|------|
| 002594 比亚迪 | 50 | 91.00 | 89.84 | -58元 (-1.3%) |
| 600370 | 600 | 2.27 | 1.57 | -417元 (-30.7%) |
| **合计** | — | 5,909元 | 5,434元 | **-475元 (-8.0%)** |
...
| Python 模块 | 19 个 (+cli/improvement_loop.py) |
| Django 页面 | 5 个路由 |
| 定时任务 | 6 个运行中（持久化） |
| 预测回填 | 40 条 | MAE 1.39元 | 区间命中 85% |
...
### 当前运行状态 (2026-06-16 10:45)

**比亚迪 002594:** 89.84元 | 评分 51/100 | 趋势 下跌
PE 82%分位(偏高) PB 1%分位(极便宜) → 分歧信号，不建议买入
持仓 50股 @91.00 | 下次加仓 @81.90 (还需跌 9.7%)

**600370:** 1.57元 | 评分 50/100
持仓 600股 @2.27 | 盈亏 -30.7% | 已加仓1次, 剩余2次
下次加仓 @1.35 (还需跌 16.3%)

**920839:** 29.34元 | 评分 65/100 | 距买入差5分 — 最接近

**600567:** 1.39元 | 评分 50/100

**6个Cron运行中:** 10步循环 + 600370监控 + 4次dashboard（全部持久化）

**最后更新:** 2026-06-16 10:50 CST
